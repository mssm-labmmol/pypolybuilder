...
class Printer(object):
    ...
    @classmethod
    def printGROMACSCoordFile(cls,top):
        f = open(gro_filename, 'w')
        f.write("Positions\n")
    ...
    def printGromos(cls,top):
        ...
        for dihedral in impropers:
            ...
            #func = "%10s" % str(dihedral.get_func())
            param = "%5s" % str(dihedral.get_param())
