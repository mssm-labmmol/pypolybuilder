...
class Angle(object):
    ...
    def __init__(self, a1, a2, a3, func, param, isDetermined = False):
        self.__a1 = a1
        self.__a2 = a2
        self.__a3 = a3
        self.__func = func
    ...
    def find_angle_param(self):
        ...
        if self.get_param() is None:
            print_pypoly_warning("Warning: Angle {} - {} - {} has type none.".format(self.get_a_1().get_atomtype(),
                                                                                     self.get_a_2().get_atomtype(),
                                                                                     self.get_a_3().get_atomtype()))
    ...
    def get_all_atoms_nr(self):
        return [self.get_a_1().get_nr(), self.get_a_2().get_nr(), self.get_a_3().get_nr()]
