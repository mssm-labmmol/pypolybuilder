    ...
    def find_bond_param(self):
        for param in Utils.ff_param.get_bond_params():
            if(param.get_atom_1_name() == self.a1.get_atomtype() and
               param.get_atom_2_name() == self.a2.get_atomtype()):
                self.__param = param.get_param()
            elif(param.get_atom_2_name() == self.a1.get_atomtype() and
                 param.get_atom_1_name() == self.a2.get_atomtype()):
                self.__param = param.get_param()

        if self.get_param() is None:
            print_pypoly_warning("Warning: Bond {} - {} has type none.".format(str(self.get_a_1().get_atomtype()),
                                                                               str(self.get_a_2().get_atomtype())))
